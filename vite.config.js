...
export default defineConfig({
  // Vite serves from frontend/ — so URLs start after this folder
  root: 'frontend',
  ...
  server: {
    ...
    proxy: {
      ...
      '/families': { target: 'http://127.0.0.1:8000', changeOrigin: true },
      '/nannies': { target: 'http://127.0.0.1:8000', changeOrigin: true },
      '/connections': { target: 'http://127.0.0.1:8000', changeOrigin: true },
      '/contracts': { target: 'http://127.0.0.1:8000', changeOrigin: true },
